...
def kb_pishva_main():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("♟️ ثبت مسابقه", callback_data="match_add"),
         InlineKeyboardButton("🏆 ثبت نتیجه", callback_data="match_result")],
        [InlineKeyboardButton("🏅 تورنمنت", callback_data="menu_tournament"),
         InlineKeyboardButton("👤 بازیکنان", callback_data="menu_players")],
        ...
        [InlineKeyboardButton("👑 پنل پیشوا", callback_data="menu_pishva"),
         InlineKeyboardButton("👥 مدیران", callback_data="menu_admins")],
        ...
        [InlineKeyboardButton("🔄 به‌روزرسانی داشبورد", callback_data="refresh_dashboard")],
    ])
...
def kb_tournament_manager_main():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🔍 تاریخچه مسابقات", callback_data="match_history"),
         InlineKeyboardButton("❓ راهنما", callback_data="menu_help")],
        [InlineKeyboardButton("⚙️ همه بخش‌ها", callback_data="menu_matches")],
    ])

def kb_security_manager_main():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("👥 بازیکنان فعال", callback_data="player_continuing"),
         InlineKeyboardButton("⚠️ بازیکنان با اخطار", callback_data="player_list")],
...
def kb_player_actions(player_id: int, role: str = "pishva"):
    rows = [
        ...
        [InlineKeyboardButton("📈 امتیاز Elo", callback_data=f"elo_player_{player_id}"),
         InlineKeyboardButton("🔮 پیش‌بینی", callback_data=f"predict_menu_{player_id}")],
    ]
    if role == "pishva":
