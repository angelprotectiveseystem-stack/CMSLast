...
from auth import (
    ...
    show_pishva_welcome, show_admin_welcome
)
...
async def setup_commands(app):
    pishva_commands = [
        ...
        BotCommand("terminal", "تله‌متری سیستم"),
    ...
    # Set commands for pishva
    try:
        from telegram import BotCommandScopeChat
        await app.bot.set_my_commands(pishva_commands, scope=BotCommandScopeChat(chat_id=PISHVA_ID))
...
def build_application():
    ...
    # Access requests (global — works from anywhere)
